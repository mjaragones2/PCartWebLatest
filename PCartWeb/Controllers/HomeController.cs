...
namespace PCartWeb.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var getprods = dbase.ProductDetails.ToList();
            foreach(var prod in getprods)
            {
                var updateprod = dbase.ProductDetails.Where(x => x.Id == prod.Id).FirstOrDefault();

                updateprod.Product_image = "products.png";
                dbase.Entry(updateprod).State = EntityState.Modified;
                dbase.SaveChanges();
            }
